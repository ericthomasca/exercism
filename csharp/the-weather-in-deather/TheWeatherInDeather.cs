...
public class WeatherStation
{
    ...
    {
        get => !reading.Equals(new Reading()) ? reading.Pressure switch
        {
            decimal p when p < 10m && reading.Temperature < 30m => Outlook.Cool,
            _ => reading.Temperature > 50m ? Outlook.Good : Outlook.Warm
